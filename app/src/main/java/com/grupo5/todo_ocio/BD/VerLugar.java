...
public class VerLugar extends AppCompatActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mTag = (TextView) findViewById(R.id.lblCatDB);
        mBiografia = (TextView) findViewById(R.id.lblDescDB);
        bar = (RatingBar) findViewById(R.id.barraNotaVer);
        img = (ImageView) findViewById(R.id.imgVer);
        mLugarID = getIntent().getStringExtra(Lista.EXTRA_LUGAR_ID);
    ...
    private void mostrarLugar(Lugar lugar) {
        ...
        mTag.setText(lugar.getTag());
        mBiografia.setText(lugar.getBiografia());
        bar.setRating(Float.parseFloat(lugar.getPuntuacion()));
    ...
    private void mostrarEditar() {
        ...
        startActivityForResult(intent, Lista.REQUEST_UPDATE_DELETE_LUGAR);
    }
